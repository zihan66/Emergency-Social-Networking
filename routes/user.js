...
router.put("/:userId/offline", loginLogoutController.logout);
...
router.put(
  "/:username/inactive",
  administerUserProfileController.ChangeToInactive
);
...
router.get(
  "/edit/:username",
  suspend,
  administerUserProfileController.renderOneUserRecord
);
